    ...
    <>
      <nav 
        className={`fixed left-1/2 -translate-x-1/2 z-50 transition-all duration-500 rounded-full ${
          scrolled 
            ? 'top-4 w-[98%] bg-white/80 backdrop-blur-xl shadow-lg border border-white/20 py-2' 
          ...
          <div className="hidden xl:flex items-center gap-4 flex-shrink-0 z-50 pr-2">
              ...
              <div className="relative">
                <button 
                  ...
                  className={`flex items-center gap-2 px-3 py-2 rounded-full transition-all duration-300 text-[11px] font-bold tracking-wider group border border-transparent ${
